...
def train_pinn(
    ...
    model = PINN(hidden_dim=hidden_dim, num_hidden_layers=num_hidden_layers, input_dim=input_dim, output_dim=output_dim).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_path", type=str, default="pinn_model.pth")
    parser.add_argument("--log_path", type=str, default="pinn_train_log.csv")
