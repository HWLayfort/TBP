...
class FPINN(nn.Module):
    def __init__(self, 
        ...
        self.ff = FourierFeatureMapping(input_dim, fourier_mapping_size, fourier_scale)
        self.input_layer = nn.Linear(fourier_mapping_size * 2, hidden_dim)
...
def train_fpinn(
    ...
    model = FPINN(hidden_dim=hidden_dim, 
                  num_hidden_layers=num_hidden_layers, 
                  input_dim=input_dim, 
                  output_dim=output_dim,
                  fourier_mapping_size=fourier_mapping_size,
                  fourier_scale=fourier_scale).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_path", type=str, default="fpinn_model.pth")
    parser.add_argument("--log_path", type=str, default="fpinn_train_log.csv")
