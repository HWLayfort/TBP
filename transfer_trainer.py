...
class FNOSingleStepDistillDataset(torch.utils.data.Dataset):
...
def transfer_train(target_model, source_model, 
    ...
    distill_dataset = FNOSingleStepDistillDataset(file_list[:10], source_model, device=device)
...
if __name__ == "__main__":
    fno_teacher = FNO1d(modes=32, width=64, input_dim=22, output_dim=9, depth=4)
    fno_teacher.load_state_dict(torch.load('fno.pth', map_location='cpu'))
    ...
    deeponet_teacher.load_state_dict(torch.load('deeponet.pth', map_location='cpu'))
    ...
    transfer_train(pinn_student, fno_teacher, data_dir='data/output', num_epochs=1, log_path='fno_to_pinn.log')
    transfer_train(pinn_student, tfno_teacher, data_dir='data/output', num_epochs=1, log_path='tfno_to_pinn.log')
    transfer_train(pinn_student, deeponet_teacher, data_dir='data/output', num_epochs=1, log_path='deeponet_to_pinn.log')
    
    # Knowledge Distillation: FNO, TFNO, DeepONet → FPINN
    transfer_train(fpinn_student, fno_teacher, data_dir='data/output', num_epochs=1, log_path='fno_to_fpinn.log')
    transfer_train(fpinn_student, tfno_teacher, data_dir='data/output', num_epochs=1, log_path='tfno_to_fpinn.log')
    transfer_train(fpinn_student, deeponet_teacher, data_dir='data/output', num_epochs=1, log_path='deeponet_to_fpinn.log')
    
    # Knowledge Distillation: FNO, TFNO, DeepONet → ResPINN
    transfer_train(respinn_student, fno_teacher, data_dir='data/output', num_epochs=1, log_path='fno_to_respinn.log')
    transfer_train(respinn_student, tfno_teacher, data_dir='data/output', num_epochs=1, log_path='tfno_to_respinn.log')
    transfer_train(respinn_student, deeponet_teacher, data_dir='data/output', num_epochs=1, log_path='deeponet_to_respinn.log')
